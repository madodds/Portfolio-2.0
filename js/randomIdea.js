...
module.controller('ideaCtrl', function ($scope, $http) {
    ...
    var JSONdata = {};
    $http.get('https://raw.githubusercontent.com/madodds/Game-Idea-Generator/master/Attributes.json').success(function (data) {
        JSONdata = data;
...
function checkAn(anString) {
    ...
    //.directive('randomIdeaGenerator', function () {
    //    return {
    //        restrict: 'E',
    //        scope:{
    //            name:'@'
    //        },
    //        templateUrl: 'partials/randomIdea.html'
    //    };
    //});
